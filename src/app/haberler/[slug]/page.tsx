  ...
  return (
    <div className="page-flow min-h-screen bg-[var(--lale-emerald-deep)]">
      <PageHero
        eyebrow="Blog Yazısı"
        title={<>{haber?.title}</>}
        description={haber?.subtitle || 'BEYVIP Translation Office tercüme süreçleri ve resmi evrak hazırlığı hakkında güncel içerikler.'}
        image="/beyvip/hero.png"
        imageAlt="BEYVIP Translation Office haber detayı"
