...
const AdminMessages = () => {
  ...
  const getServiceTypeText = (serviceType: string) => {
    switch (serviceType) {
      case 'pasaport-tercumesi': return 'Pasaport Tercümesi';
      case 'yeminli-tercume': return 'Yeminli Tercüme';
      case 'noter-onayli-tercume': return 'Noter Onaylı Tercüme';
      case 'diploma-transkript': return 'Diploma / Transkript';
      case 'vize-evraklari': return 'Vize Evrakları';
      case 'hukuki-tercume': return 'Hukuki Tercüme';
