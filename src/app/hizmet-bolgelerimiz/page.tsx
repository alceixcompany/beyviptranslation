  ...
  return (
    <div className="page-flow min-h-screen bg-[var(--lale-emerald-deep)]">
      <PageHero
        ...
        description="İstanbul ve Türkiye genelinde belge gönderimiyle ilerleyen tercüme hizmet alanlarımızı inceleyin."
        image="/beyvip/hero.png"
        imageAlt="BEYVIP Translation Office hizmet alanları"
        align="center"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[var(--lale-gold)] opacity-70 max-w-2xl mx-auto">
              Size en uygun tercüme sürecini planlamak için hizmet alanlarını inceleyin ve bizimle iletişime geçin.
            </p>
          </div>
      ...
      <section className="lale-dark-section py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[var(--lale-gold)] opacity-70 max-w-2xl mx-auto">
              Tercüme süreçlerimizden ve resmi belge hazırlığından seçilen kareler
            </p>
          </div>
